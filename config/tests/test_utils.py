...
class DecimalPrecisionTest(TestCase):
    ...
    def test_validate_decimal_precision(self):
        ...
        self.assertTrue(DecimalPrecision.validate_precision(value, 2))
        
        # Invalid precision (too many decimal places)
        value = Decimal('123.456')
        self.assertFalse(DecimalPrecision.validate_precision(value, 2))
        
        # Zero precision
        value = Decimal('123')
        self.assertTrue(DecimalPrecision.validate_precision(value, 0))
...
class ValidationUtilsTest(TestCase):
    ...
    def test_validate_account_number(self):
        ...
        self.assertFalse(ValidationUtils.validate_account_number('abc'))
        self.assertFalse(ValidationUtils.validate_account_number('1000-'))
    ...
    def test_validate_amount(self):
        ...
        self.assertFalse(ValidationUtils.validate_amount(Decimal('1000000.00')))
...
class DateUtilsTest(TestCase):
    ...
    def test_get_fiscal_year_start(self):
        """Test getting fiscal year start date."""
        # Test with default fiscal year start (July 1)
        test_date = date(2024, 3, 15)
        fiscal_start = DateUtils.get_fiscal_year_start(test_date)
        self.assertEqual(fiscal_start, date(2023, 7, 1))
        
        # Test with custom fiscal year start (January 1)
        test_date = date(2024, 3, 15)
        fiscal_start = DateUtils.get_fiscal_year_start(test_date, 1)
        self.assertEqual(fiscal_start, date(2024, 1, 1))

    def test_get_fiscal_year_end(self):
        """Test getting fiscal year end date."""
        # Test with default fiscal year start (July 1)
        test_date = date(2024, 3, 15)
        fiscal_end = DateUtils.get_fiscal_year_end(test_date)
        self.assertEqual(fiscal_end, date(2024, 6, 30))
        
        # Test with custom fiscal year start (January 1)
        test_date = date(2024, 3, 15)
        fiscal_end = DateUtils.get_fiscal_year_end(test_date, 1)
        self.assertEqual(fiscal_end, date(2024, 12, 31))
    ...
    def test_get_quarter_dates(self):
        ...
        self.assertEqual(quarter_dates[0], date(2024, 4, 1))
        self.assertEqual(quarter_dates[1], date(2024, 6, 30))
    ...
    def test_get_month_dates(self):
        ...
        self.assertEqual(month_dates[0], date(2024, 5, 1))
        self.assertEqual(month_dates[1], date(2024, 5, 31))
...
class SecurityUtilsTest(TestCase):
    ...
    def test_validate_password_strength(self):
        ...
        weak_password = "123"
        self.assertFalse(SecurityUtils.validate_password_strength(weak_password))
